...
//
// The moment a real YOUTUBE_API_KEY is present, prefetch uses the live API
// instead and this source goes dormant.

export const DEMO_MODE = !process.env.YOUTUBE_API_KEY;
